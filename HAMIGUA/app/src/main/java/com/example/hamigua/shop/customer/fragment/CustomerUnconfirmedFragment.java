...
import com.example.hamigua.shop.customer.adapter.CustomerUnconfirmedAdapter;
...
public class CustomerUnconfirmedFragment extends Fragment implements CustomerUnconfirmedAdapter.OnItemClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_shop_customer_unconfirmed, container, false);
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if(task.isSuccessful() && task.getResult() != null) {
                            ...
                            recyclerView.setAdapter(new CustomerUnconfirmedAdapter(getActivity(), arrOrderData, CustomerUnconfirmedFragment.this));
    ...
    public void onItemClick(OrderData orderData) {
        ChatUserData user = new ChatUserData(orderData.sellerID, orderData.sellerName, null, null);
