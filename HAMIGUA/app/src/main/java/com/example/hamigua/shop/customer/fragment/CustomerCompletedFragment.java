...
public class CustomerCompletedFragment extends Fragment implements CustomerCompletedAdapter.OnItemClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_shop_customer_completed, container, false);
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if(task.isSuccessful() && task.getResult() != null) {
                            ...
                            recyclerView.setAdapter(new CustomerCompletedAdapter(getActivity(), arrOrderData, CustomerCompletedFragment.this));
