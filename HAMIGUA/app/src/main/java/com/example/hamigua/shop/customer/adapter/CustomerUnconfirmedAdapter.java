...
public class CustomerUnconfirmedAdapter extends RecyclerView.Adapter<CustomerUnconfirmedAdapter.ViewHolder> {

    ArrayList<OrderData> arrOrderData;
    Context context;

    CustomerUnconfirmedAdapter.OnItemClickListener cListener;

    public CustomerUnconfirmedAdapter(Context context, ArrayList<OrderData> arrOrderData, OnItemClickListener cListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.shop_customer_unconfirmed_order_grid_layout, parent, false), cListener);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView, CustomerUnconfirmedAdapter.OnItemClickListener cListener) {
            super(itemView);
