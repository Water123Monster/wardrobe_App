...
public class SellerUnratedAdapter extends RecyclerView.Adapter<SellerUnratedAdapter.ViewHolder> {
    ...
    public SellerUnratedAdapter(Context context, ArrayList<OrderData> arrOrderData, OnItemClickListener cListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.shop_seller_unrated_order_grid_layout, parent, false), cListener);
    }
