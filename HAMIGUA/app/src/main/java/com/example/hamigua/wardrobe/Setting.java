...
public class Setting extends AppCompatActivity {
    ...
    public String[] setting_str = {"我的資料", "人偶設定", "穿搭喜好設定", "登出", "刪除帳號"};
    ...
    private ListView.OnItemClickListener onClickListView = new ListView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            switch(position){
                case 0:
                    Intent intent_Setting_Authority = new Intent(Setting.this, Setting_Authority.class);
                    startActivity(intent_Setting_Authority);
                    break;
                case 1:
                    Intent intent_HAGE_Setting = new Intent(Setting.this, HAGE_Setting.class);
                    startActivity(intent_HAGE_Setting);
                    break;
                case 2:
                    Intent intent_PersonalPreferenceSetting = new Intent(Setting.this, PersonalPreferenceSetting.class);
                    startActivity(intent_PersonalPreferenceSetting);
                    break;
                case 3:
                    log_Out_Account();
                    break;
    ...
    protected void log_Out_Account() {
        ...
        dialog.setPositiveButton("登出", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Toast.makeText(Setting.this, "登出成功，感謝您使用哈密瓜智慧衣櫃", Toast.LENGTH_SHORT).show();

                //設置延遲，跳出登出訊息Toast後1000毫秒再進行跳轉頁面至(MainActivity.java)
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent intent_logout = new Intent(Setting.this, MainActivity.class);
                                ...
                                firebaseUser.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull @NotNull Task<Void> task) {
                                        ...
                                        //若刪除authentication裡的使用者資料失敗
                                            ...
                                            Toast.makeText(Setting.this, "刪除帳號失敗\n" + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                            }
