...
public class SellerCompletedAdapter extends RecyclerView.Adapter<SellerCompletedAdapter.ViewHolder> {
    ...
    public SellerCompletedAdapter(Context context, ArrayList<OrderData> arrOrderData, OnItemClickListener cListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.shop_seller_completed_order_grid_layout, parent, false), cListener);
    }
