...
public class SellerUnconfirmedAdapter extends RecyclerView.Adapter<SellerUnconfirmedAdapter.ViewHolder> {
    ...
    public SellerUnconfirmedAdapter(Context context, ArrayList<OrderData> arrOrderData, OnItemClickListener cListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.shop_seller_unconfirmed_order_grid_layout, parent, false), cListener);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        //設定賣場名稱
        holder.unconfirmed_seller_name.setText(data.buyerName);
