...
public class CustomerUnratedAdapter extends RecyclerView.Adapter<CustomerUnratedAdapter.ViewHolder> {
    ...
    public CustomerUnratedAdapter(Context context, ArrayList<OrderData> arrOrderData, OnItemClickListener cListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.shop_customer_unrated_order_grid_layout, parent, false), cListener);
    }
